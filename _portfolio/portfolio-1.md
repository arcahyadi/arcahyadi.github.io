...
This certificate verifies the successful completion of the **CCNA: Introduction to Networks** course, part of the Cisco Networking Academy program. 
...
[📄 View Certificate (PDF)]({{ site.baseurl }}/files/Introduct-certificate.pdf)