...
This certificate verifies the successful completion of the **CCNA: Switching, Routing, and Wireless Essentials** course, part of the Cisco Networking Academy program.
...
[📄 View Certificate (PDF)]({{ site.baseurl }}/files/Switching-certificate.pdf)