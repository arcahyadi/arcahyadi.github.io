...
This certificate verifies the successful completion of the **CCNA: Enterprise Networking, Security, and Automation** course, part of the Cisco Networking Academy program.
...
[📄 View Certificate (PDF)]({{ site.baseurl }}/files/Enterpris-certificate.pdf)